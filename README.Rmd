...
This is a minimal package to help with the compilation and analysis of tax and economic data in South Africa. The package only contains six main sets of data, three functions and the personal income tax tables from 1995/96 to 2021/22.
...
The data can be accessed by directly entering either `SARS_annual`, `SARS_monthly`, `NT_forecasts`, `STATSSA` or `SARB` and is in a tidy format to ease analysis within R.
